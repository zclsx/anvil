  ...
  return (
    <div className="border border-outline-variant bg-surface-container-low">
      <div
        ...
        className="flex items-center gap-2 px-3 py-1.5 cursor-pointer hover:bg-surface-container text-[11px] font-mono-label"
      >
        <ChevronRight
          size={12}
        ...
        <span className="ml-auto shrink-0 flex items-center gap-2">
          {!expanded && summary.resultPreview && (
            <span className="font-mono-code text-on-surface-variant/70 truncate max-w-[200px]">
